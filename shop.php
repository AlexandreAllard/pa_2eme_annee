                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                ...
                                <div class="text-center">
                                  ...
                                  <form method="post" action="./Stripe/achat_shop.php">
                                    <?php echo '<button class="btn btn-outline-dark mt-auto" type="submit" value="'.$produit['id_produit'].'" name="id_produit">Acheter</button>'  ?>
                                    </form>
                                  <?php }else { ?>
                                    <form method="post" action="login.php">
                                      <?php echo '<button class="btn btn-outline-dark mt-auto" type="submit">Acheter</button>'  ?>
                                      </form>
