...
// fin traitement image
	...
	if( empty($listOfErrorsProducts) ){
		...
		$queryPrepared =  $connection->prepare("INSERT INTO caf_produit (nom_produit, prix_produit, description_produit, photo_produit) VALUES ( :nom_produit, :prix_produit, :description_produit, :photo_produit);");

		$queryPrepared->execute( ["nom_produit"=>$productName,"prix_produit"=>$productPrice,"description_produit"=>$productDescription,"photo_produit"=>$productPhoto] );
