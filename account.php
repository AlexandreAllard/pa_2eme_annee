  ...
  <main class="flex-shrink-0">
      ...
      <div class="">
        <div class="">
          <div>
            <div>
            <h2 class="balise">Mon</h2>
            <h2 class="balise orange">compte</h2>
            </div>
          </div>
          ...
          <form class="user" action="modify_infos.php" method="POST" id="scroll_modify_infos">
            ...
            <div class="container1">
              <div class="text form-group">
                  <input type="text" class="form-control form-control-user inputField" id="lastName"
                      name="lastName" placeholder="Nom"
                      value="<?php echo $infos_client['nom'];?>" required>
              </div>
                <div class="text form-group">
                    <input type="text" class="inputField form-control form-control-user" id="firstName"
                        name="firstName" placeholder="Prénom"
                        value="<?php echo $infos_client['prenom'];?>" required>
                </div>
            </div>
            <div class="container2 text">
                <input type="email" class="inputField form-control form-control-user" id="email"
                    name="email" placeholder="Adresse mail"
                    value="<?php echo $infos_client['adresse_mail'];?>" required>
            </div>
            <div class="container1">
                <div class="text">
                    <input type="date" class="inputField form-control form-control-user" id="birthdate"
                    name="birthdate" placeholder="Date de naissance"
                    value="<?php echo $infos_client['date_de_naissance'];?>" required>
                </div>
                <div class="text">
                    <input type="tel" class="inputField form-control form-control-user" id="phone"
            ...
            <div class="container3 text">
                <input type="text" class="inputField form-control form-control-user" id="numWay"
                    name="numWay" placeholder="Numéro"
                    value="<?php echo $infos_client['numero_voie'];?>" required>
                <input type="text" class="inputField form-control form-control-user" id="typeWay"
                    name="typeWay" placeholder="Type de voie"
                    value="<?php echo $infos_client['type_voie'];?>"  required>
                <input type="text" class="inputField form-control form-control-user" id="nameWay"
                    name="nameWay" placeholder="Nom de voie"
                    value="<?php echo $infos_client['nom_voie'];?>" required>
            </div>
            <div class="container1">
                <div class="text">
                    <input type="postalCode" class="inputField form-control form-control-user" id="postalCode"
                    name="postalCode" placeholder="Code postal"
                    value="<?php echo $infos_client['code_postal'];?>" required>
                </div>
                <div class="text">
                    <input type="text" class="inputField form-control form-control-user" id="city"
                    name="city" placeholder="Ville"
                    value="<?php echo $infos_client['ville'];?>" required>
                </div>
            </div>
            <div class="container2 text">
                <input type="text" class="inputField form-control form-control-user" id="moreInfos"
                    name="moreInfos" placeholder="Informations supplémentaires"
                    value="<?php echo $infos_client['indication_supplementaire'];?>" required>
            </div>
            ...
            <br>
                ...
                <form class="user" action="modify_password.php" method="POST" id="scroll_modify_password">
                  <div class="container2 text">
                      <input type="password" class="inputField form-control form-control-user" id="pwd_old"
                          name="pwd_old" placeholder="Ancien mot de passe" required>
                  </div>
                  <div class="container1">
                      <div class="text">
                          <input type="password" class="inputField form-control form-control-user" id="new_pwd"
                          name="new_pwd" placeholder="Nouveau mot de passe" required>
                      </div>
                      <div class="text">
                          <input type="password" class="inputField form-control form-control-user" id="new_pwd_conf"
