...
if ($fidelity_use > $nb_fidelity_max) {
  $listOfErrorsAchat[] =  "Ton nombre de point saisit dépasse le nombre de point possible pour cet achat !";
    ...
    $id_forfait = $_SESSION['id_forfait_select'];
...
*/
    ...
    $final_price=finalPrice($forfait_prix_euro,$fidelity_use );
...
<?php
    ...
    echo "<br>Forfait : ".$forfaitNom;
    echo "<br>Prix initial : ".$forfait_prix_euro." € ";
...
?>
    ...
    <form action="payment_forfait.php" method="post" id="payment-form">
      ...
      <div class="text-center">
        <button class="btn btn-outline-dark mt-auto" type="submit" action="payment_forfait.php">Je valide mon achat</button>
        <a class="btn btn-outline-dark mt-auto" href="../pricing.php">J'annule mon achat</a>
      </div>
	...
	if(!empty($listOfErrorsAchat)) {
		//Afficher les erreurs sur la page achat_forfait.php
		$_SESSION["listOfErrorsAchat"] = $listOfErrorsAchat;
		header("Location: achat_forfait.php");
	}
  ?>
